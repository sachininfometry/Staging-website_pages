...
<main class="fdp-page" id="fdp-page">
	...
	<section class="fdp-hero" aria-labelledby="fdp-title">
		<div class="fdp-shell fdp-hero-grid"><div class="fdp-hero-copy"><span class="fdp-kicker">Case Study</span><h1 id="fdp-title">Financial Data Platform<br>(FDP 2.0) Modernization<br>on Snowflake</h1><p>Infometry was engaged to assess, redesign, and modernize Asana’s existing Financial Data Platform by implementing a modular Snowflake architecture that simplifies data integration, accelerates financial reporting, strengthens governance, and establishes a scalable foundation for enterprise analytics and future business growth.</p><div class="fdp-tags"><span>Asana</span><span>SaaS</span><span>Snowflake</span><span>Data Modernization</span></div><a class="fdp-button" href="<?php echo esc_url( $contact_url ); ?>">Talk to an Expert <span>→</span></a></div><div class="fdp-hero-visual" aria-label="Asana and Snowflake modernization illustration"><div class="fdp-data-waves"><i></i><i></i><i></i></div><div class="fdp-asana-brand"><span class="fdp-asana-mark"><i></i><i></i><i></i></span><strong>asana</strong><span class="fdp-asana-tagline">Smarter data.<br>Greater impact.</span></div><span class="fdp-glass fdp-glass-one"></span><span class="fdp-glass fdp-glass-two"></span><span class="fdp-glass fdp-glass-three"></span><div class="fdp-snow-card"><div class="fdp-snow-mark"><img src="<?php echo esc_url( INFOMETRY_CT_URL . 'assets/images/snowflake-logo.png' ); ?>" alt="Snowflake"></div></div><div class="fdp-visual-values"><span>Modernize</span><span>Unify</span><span>Scale</span></div></div></div>
	</section>
