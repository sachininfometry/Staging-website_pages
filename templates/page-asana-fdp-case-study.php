...
<main class="fdp-page" id="fdp-page">
	...
	<section class="fdp-hero" aria-labelledby="fdp-title">
		<header class="fdp-nav fdp-shell"><a class="fdp-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( INFOMETRY_CT_URL . 'assets/images/infometry-logo-white.png' ); ?>" alt="Infometry Inc."></a><nav aria-label="Case study navigation"><a href="<?php echo esc_url( home_url( '/product/' ) ); ?>">Products</a><a href="<?php echo esc_url( home_url( '/snowflake-solutions/' ) ); ?>">Solutions</a><a href="<?php echo esc_url( home_url( '/resources/infometry-case-studies/' ) ); ?>">Case Studies</a><a href="<?php echo esc_url( home_url( '/company/' ) ); ?>">Company</a></nav><a class="fdp-nav-cta" href="<?php echo esc_url( $contact_url ); ?>">Contact Us</a></header>
		<div class="fdp-shell fdp-hero-grid"><div class="fdp-hero-copy"><span class="fdp-kicker">Case Study</span><h1 id="fdp-title">Financial Data Platform (FDP 2.0) Modernization on Snowflake</h1><p>Infometry was engaged to assess, redesign, and modernize Asana’s existing Financial Data Platform by implementing a modular Snowflake architecture that simplifies data integration, accelerates financial reporting, strengthens governance, and establishes a scalable foundation for enterprise analytics and future business growth.</p><div class="fdp-tags"><span>Asana</span><span>SaaS</span><span>Snowflake</span><span>Data Modernization</span></div><a class="fdp-button" href="<?php echo esc_url( $contact_url ); ?>">Talk to an Expert <span>→</span></a></div><div class="fdp-hero-visual"><img class="fdp-asana-logo" src="<?php echo esc_url( INFOMETRY_CT_URL . 'assets/images/customer-asana-logo.png' ); ?>" alt="Asana"><div class="fdp-snow-card"><img src="<?php echo esc_url( INFOMETRY_CT_URL . 'assets/images/snowflake-product-mark.png' ); ?>" alt="Snowflake"><span>Modernize</span><span>Govern</span><span>Scale</span></div></div></div>
	</section>
	...
	<section class="fdp-section fdp-modernization"><div class="fdp-shell"><div class="fdp-heading"><span class="fdp-section-label">Architecture Transformation</span><h2>From Legacy to Modern</h2></div><figure><img src="<?php echo esc_url( INFOMETRY_CT_URL . 'assets/images/case-studies/asana-fdp-modernization.png' ); ?>" alt="Asana, Infometry, and Snowflake integration architecture"><figcaption>Asana’s Financial Data Platform modernized with Infometry and Snowflake.</figcaption></figure></div></section>
