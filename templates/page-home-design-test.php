			...
			<div class="infometry-who-panel">
				...
				<div class="infometry-who-insight">
					...
					<div class="infometry-who-pillars">
						<article><svg><use href="#i-target"/></svg><h3>Data Analytics<br>Services</h3><p>Transform enterprise data into actionable insights with advanced, predictive, and prescriptive analytics.</p><small>Advanced Analytics · Predictive Analytics · Prescriptive Analytics · BI · Data Visualization</small></article>
						...
						<article><svg><use href="#i-rocket"/></svg><h3>AI/ML &amp; Agentic<br>AI</h3><p>Automate analysis, surface insights, and support smarter decisions with AI/ML and Agentic AI.</p><small>Machine Learning · Generative AI · Agentic AI · Conversational Analytics · Decision Intelligence</small></article>
						...
						<article><svg><use href="#i-grid"/></svg><h3>Intelligent<br>Automation</h3><p>Reduce manual effort and accelerate data operations with low-code, no-code, and intelligent automation.</p><small>Data Testing · Metadata Discovery · DDL Automation · Workflow Automation</small></article>
					</div>
