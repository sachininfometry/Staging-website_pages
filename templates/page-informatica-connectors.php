...
<main class="infometry-informatica-product" id="infometry-informatica-product">
	...
	<footer class="iin-footer"><div class="iin-shell iin-footer-grid"><div><img src="<?php echo esc_url( INFOMETRY_CT_URL . 'assets/images/infometry-logo-white.png' ); ?>" alt="Infometry"><p>Building intelligent data solutions that drive real business impact.</p></div><div><h3>Solutions</h3><a href="#">Data Integration</a><a href="#">Data Engineering</a><a href="#">Cloud Analytics</a></div><div><h3>Products</h3><a href="#featured-connectors">Informatica IDMC Connectors</a><a href="<?php echo esc_url( home_url( '/product/conversational-analytics/' ) ); ?>">INFOFISCUS Conversa</a><a href="#">Data Platform Accelerators</a></div><div><h3>Resources</h3><a href="#">Documentation</a><a href="#">Blogs</a><a href="#">Case Studies</a></div><div><h3>Company</h3><a href="#">About Us</a><a href="#">Careers</a><a href="<?php echo esc_url( $contact_url ); ?>">Contact Us</a></div></div><div class="iin-shell iin-footer-bottom"><span>© 2026 Infometry Inc. All rights reserved.</span><span>Enabling AI for Every Enterprise</span></div></footer>
</main>
